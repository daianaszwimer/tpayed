...
void crearMapa(NODO *&P){
	...
	CL->demora[0]=(rand()%2)*VEL;					
	CL->demora[1]=(rand()%2)*VEL;				
	C1->demora[0]=(rand()%2)*VEL;	
	C1->demora[1]=(rand()%2)*VEL;					
	C1->demora[2]=(rand()%2)*VEL;					
	C2->demora[0]=(rand()%2)*VEL;	
	C2->demora[1]=(rand()%2)*VEL;	
	C2->demora[2]=(rand()%2)*VEL;					
	C2->demora[3]=(rand()%2)*VEL;				
	C3->demora[0]=(rand()%2)*VEL;	
	C3->demora[1]=(rand()%2)*VEL;	
	C3->demora[2]=(rand()%2)*VEL;					
	C3->demora[3]=(rand()%2)*VEL;					
	C4->demora[0]=(rand()%2)*VEL;	
	C4->demora[1]=(rand()%2)*VEL;	
	C4->demora[2]=(rand()%2)*VEL;					
	C5->demora[0]=(rand()%2)*VEL;	
	C5->demora[1]=(rand()%2)*VEL;	
	C5->demora[2]=(rand()%2)*VEL;					
	C5->demora[3]=(rand()%2)*VEL;					
	C6->demora[0]=(rand()%2)*VEL;	
	C6->demora[1]=(rand()%2)*VEL;					
	C6->demora[2]=(rand()%2)*VEL;					
	C7->demora[0]=(rand()%2)*VEL;	
	C7->demora[1]=(rand()%2)*VEL;	
	C7->demora[2]=(rand()%2)*VEL;					
	CC->demora[1]=(rand()%2)*VEL;	
	CC->demora[2]=(rand()%2)*VEL;
