...
void crearMapa(NODO *&P){
	...
	CL->demora[0]=((float) (rand()%2) / (RAND_MAX))*VEL;					
	CL->demora[1]=((float) (rand()%2) / (RAND_MAX))*VEL;				
	C1->demora[0]=((float) (rand()%2) / (RAND_MAX))*VEL;	
	C1->demora[1]=((float) (rand()%2) / (RAND_MAX))*VEL;					
	C1->demora[2]=((float) (rand()%2) / (RAND_MAX))*VEL;					
	C2->demora[0]=((float) (rand()%2) / (RAND_MAX))*VEL;	
	C2->demora[1]=((float) (rand()%2) / (RAND_MAX))*VEL;	
	C2->demora[2]=((float) (rand()%2) / (RAND_MAX))*VEL;					
	C2->demora[3]=((float) (rand()%2) / (RAND_MAX))*VEL;				
	C3->demora[0]=((float) (rand()%2) / (RAND_MAX))*VEL;	
	C3->demora[1]=((float) (rand()%2) / (RAND_MAX))*VEL;	
	C3->demora[2]=((float) (rand()%2) / (RAND_MAX))*VEL;					
	C3->demora[3]=((float) (rand()%2) / (RAND_MAX))*VEL;					
	C4->demora[0]=((float) (rand()%2) / (RAND_MAX))*VEL;	
	C4->demora[1]=((float) (rand()%2) / (RAND_MAX))*VEL;	
	C4->demora[2]=((float) (rand()%2) / (RAND_MAX))*VEL;					
	C5->demora[0]=((float) (rand()%2) / (RAND_MAX))*VEL;	
	C5->demora[1]=((float) (rand()%2) / (RAND_MAX))*VEL;	
	C5->demora[2]=((float) (rand()%2) / (RAND_MAX))*VEL;					
	C5->demora[3]=((float) (rand()%2) / (RAND_MAX))*VEL;					
	C6->demora[0]=((float) (rand()%2) / (RAND_MAX))*VEL;	
	C6->demora[1]=((float) (rand()%2) / (RAND_MAX))*VEL;					
	C6->demora[2]=((float) (rand()%2) / (RAND_MAX))*VEL;					
	C7->demora[0]=((float) (rand()%2) / (RAND_MAX))*VEL;	
	C7->demora[1]=((float) (rand()%2) / (RAND_MAX))*VEL;	
	C7->demora[2]=((float) (rand()%2) / (RAND_MAX))*VEL;					
	CC->demora[1]=((float) (rand()%2) / (RAND_MAX))*VEL;	
	CC->demora[2]=((float) (rand()%2) / (RAND_MAX))*VEL;
